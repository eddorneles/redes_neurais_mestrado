...
function [out_hidden_neurons] = compute_weights( x, centers, sigma, error, eta_learning_rate )
    ...
    for i = 1 : num_instances
        ...
        out_hidden_neurons(i,:) = exp( (-1 * mi^2 ) ./ (2*sigma^2) ); % element by element division
    end %for
